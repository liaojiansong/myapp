...
// arModel is a active record design model for table article_tag operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of article_tag.
	Table = "article_tag"
	// Model is the model object of article_tag.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table article_tag.
	Columns = struct {
		Id        string //
		ArticleId string //
		TagId     string //
