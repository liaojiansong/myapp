...
// arModel is a active record design model for table tag operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of tag.
	Table = "tag"
	// Model is the model object of tag.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table tag.
	Columns = struct {
		Id   string //
		Name string //
	}{
