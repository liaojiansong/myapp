...
// arModel is a active record design model for table me operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of me.
	Table = "me"
	// Model is the model object of me.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table me.
	Columns = struct {
		Id          string //
		Name        string //
		Motto       string //
